...
<template>
	<view class="page-container">
		<custom-bar title="Change Password"></custom-bar>
		<view class="page-body" :style="{paddingTop: navHeight + 'px'}">
			<view class="title">
				Confirm New Password
			</view>
			<view class="sub-title">
				Re-enter your new password to ensure it matches and complete the verification.
			</view>
		...
		<u-popup :show="verifyPopup" :overlayStyle="overlayStyle" mode="center">
			<view class="popup-body">
				...
				<view class="sub-title">
					The passwords you entered don't match. Please re-enter them to make sure they're the
				</view>
